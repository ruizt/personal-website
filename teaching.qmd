...
I consider myself a lifelong learner. At some point, it became natural to teach, both as a vehicle for further learning and as a means of giving back by helping to train future practitioners and scientists.

Much of my experience teaching statistics is concentrated around methods, applications, and data science, but I have broad interests in teaching across and beyond the discipline. I have designed a few courses; you can see an example [here](https://ruizt.github.io/pstat100). One of my more significant teaching projects involved extensive work on a capstone course sequence at UCSB that combined project-based learning with training on "soft" skills; you can read about that [here](http://ruizt.github.io/pstat197). A full list of courses I've taught follows; I'm happy to share materials for any of these for instructional purposes on request.

## Courses

### Cal Poly

#### **Probability theory** \[STAT425\] {#stat425}
...
#### **Data science capstone** \[PSTAT197\] \[[website](https://ruizt.github.io/pstat197)\] {#pstat197}
...
#### **Data science concepts and analysis** \[PSTAT100\] \[[website](https://ruizt.github.io/pstat100)\] {#pstat100}
