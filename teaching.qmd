...
I consider myself a lifelong learner. At some point, it became natural to teach, both as a vehicle for further learning and as a means of giving back by helping to train future practitioners and scientists. Much of my experience teaching statistics is concentrated around methods, applications, and data science, but I have broad interests. I have designed a few courses; you can see an example [here](https://ruizt.github.io/pstat100). One of my more significant teaching projects involved extensive work on a capstone course sequence at UCSB that combined project-based learning with training on "soft" skills; you can read about that [here](http://ruizt.github.io/pstat197). I'm happy to connect about teaching statistics and data science or to share my course materials for instructional purposes on request.

## Courses taught

### Cal Poly

**Probability theory** (STAT425): Fall 2023
...
**Data science capstone** (PSTAT197A-B-C): Winter 2022, Spring 2022, Fall 2022, Winter 2023, Spring 2023 \[[website](https://ruizt.github.io/pstat197)\]
...
**Data science concepts and analysis** (PSTAT100): Spring 2021, Winter 2022, Spring 2022, Spring 2023 \[[website](https://ruizt.github.io/pstat100)\]
...
**Statistical machine learning** (PSTAT131/231): Winter 2021, Spring 2021
...
**Regression analysis** (PSTAT126): Summer 2021, Fall 2021
...
**Probability and statistics** (PSTAT120B): Fall 2020, Winter 2021, Summer 2021, Fall 2021
...
**Introduction to statistical methods** (ST351-352): Spring 2018, Summer 2018
