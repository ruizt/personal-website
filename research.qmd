...
In some studies, high-resolution functional measurements are obtained on relatively few observational/experimental units, effectively prioritizing sampling frequency over statistical inference. This project would explore tradeoffs between statistical power and functional approximation quality in the context of permutation inference for functional data with small sample sizes based on functional principal components.

#### Iterative estimation of latent regression variables with non-latent covariate adjustments

Partial least squares is a common latent variable regression technique used for dimension reduction of covariates. In the typical model formulation, latent variables are formed from the entire covariate set; this project would consider a more flexible model formulation in which latent variables are formed from only a subset of available covariates and develop an iterative approach to estimating regression coefficients of both non-latent and latent variable sets.
